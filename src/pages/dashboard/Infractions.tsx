...
const SYSTEM_INFRACTIONS = [
  {
    id: "sys-1",
    title: "1. Incumplimiento del uniforme escolar",
    description:
  ...
  {
    id: "sys-2",
    title: "2. Uso de dispositivos móviles en clase sin autorización",
    description:
  ...
  {
    id: "sys-3",
    title: "1. Comportamiento irrespetuoso verbal",
    description:
  ...
  {
    id: "sys-4",
    title: "2. Daño intencional a bienes institucionales",
    description:
  ...
  {
    id: "sys-5",
    title: "1. Agresión física entre estudiantes",
    description:
      "Actos de violencia física que causen daño corporal a otro integrante de la comunidad educativa.",
    type: "gravisima" as const,
    legal_ref: "Art. 40 Lit. e · Decreto 1965/2013 · Ley 1620/2013",
  },
  {
    id: "sys-6",
    title: "2. Porte de armas u objetos peligrosos",
    description:
      "Ingreso o tenencia dentro de la institución de armas, explosivos, sustancias peligrosas u objetos que puedan causar daño.",
    type: "gravisima" as const,
    legal_ref: "Art. 40 Lit. f · Decreto 1965/2013 · Código Penal",
  },
  {
    id: "sys-7",
    title: "3. Acoso escolar (Bullying)",
    description:
      "Conducta de hostigamiento, acoso, intimidación o maltrato repetitivo y sistemático que vulnere los derechos del estudiante.",
    type: "gravisima" as const,
...
const TABS: { id: TabFilter; label: string }[] = [
  ...
  { id: "leve", label: "Tipo I" },
  { id: "grave", label: "Tipo II" },
  { id: "gravisima", label: "Tipo III" },
];
...
export default function InfractionsPage() {
  ...
  const fetchData = async () => {
    try {
      const infSnap = await getDocs(
        query(collection(db, "infractions"), orderBy("created_at", "desc")),
      );
      setInfractions(
        infSnap.docs.map((d) => ({ id: d.id, ...d.data() }) as Infraction),
      );
    } catch (err: any) {
  ...
  const filteredSystem = SYSTEM_INFRACTIONS.filter(
  ...
  return (
    <div
      ...
      className="bg-[#f8faff] dark:bg-[#0f1117] min-h-screen pb-24 transition-colors duration-300"
    >
      {/* Tabs */}
      ...
      <div className="p-4 lg:p-8 space-y-6">
        <div>
          <p className="text-sm text-slate-500 dark:text-slate-400">
            Faltas descriptivas para el manual de convivencia.
          </p>
        ...
        <div className="flex items-center justify-between px-1">
          {isAdmin && (
            <EduButton
              onClick={() => navigate("/dashboard/infractions/new")}
              icon={Plus}
        ...
        {filteredSystem.length > 0 && (
          <div className="space-y-3">
            <p className="text-sm font-semibold text-slate-500 dark:text-slate-400">
              {filteredSystem.length} faltas registradas.
            </p>
          ...
          <div className="space-y-3">
            ...
            {filteredInfractions.map((inf) => {
              ...
              const dateLabel = inf.date
                ? format(new Date(inf.date + "T00:00:00"), "d 'de' MMM yyyy", {
                    locale: es,
                  })
                : "—";
              return (
                      ...
                      {isAdmin && (
                        <div className="flex items-center gap-1">
                          <Button
                            ...
                            onClick={() =>
                              navigate(`/dashboard/infractions/${inf.id}/edit`)
                            }
                          >
