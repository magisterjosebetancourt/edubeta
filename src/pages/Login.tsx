...
export default function LoginPage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (error) {
       ...
       toast.error('Ocurrió un error inesperado', { description: error.message })
    } finally {
      setIsLoading(false)
    }
  }
  ...
  return (
    <div className="flex items-start justify-center min-h-screen bg-[#F3F4F6] px-4 py-8 pt-16 md:pt-24">
      ...
      <div className="w-full max-w-[420px] bg-white rounded-3xl shadow-xl p-8 md:p-10 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center space-y-2 mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">EduBeta</h1>
          <p className="text-[10px] font-bold text-blue-600 uppercase tracking-widest">
            POR BETASOFT
          </p>
          
          <div className="mt-4 space-y-1">
            <h2 className="text-sm font-medium text-slate-500">Transformación educativa</h2>
            <p className="text-xs text-slate-400 max-w-[240px] mx-auto leading-relaxed">
              Inicia sesión para gestionar la asistencia escolar y acceder a tu panel
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center ml-1">
                ...
                <Link to="#" className="text-xs font-semibold text-blue-600 hover:text-blue-700 hover:underline">
          ...
          <div className="flex items-center gap-2 ml-1">
             <input type="checkbox" id="remember" className="w-4 h-4 rounded border-slate-300 text-blue-600 focus:ring-blue-500/30" />
        ...
        <div className="mt-8 pt-6 border-t border-slate-100 text-center space-y-6">
            <p className="text-xs text-slate-500 font-medium">
                ...
                <a href="#" className="text-blue-600 font-bold hover:underline">Contacta al Administrador</a>
                <br />
                <span className="text-slate-400 font-normal">o</span>
                <br />
                <Link to="/registro-docente" className="text-blue-600 font-bold hover:underline">Registrar con Código PIN</Link>
            </p>
            ...
            <div className="flex flex-col gap-4">
                <div className="flex justify-center gap-4 text-[10px] text-slate-400 font-medium">
                    ...
                    <a href="#" className="hover:text-slate-600">Términos de Servicio</a>
